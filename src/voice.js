...
function _iosSpeak(u){const ss=window.speechSynthesis;ss.cancel();if(typeof ss.resume==='function')ss.resume();ss.speak(u);setTimeout(()=>{if(ss.paused&&typeof ss.resume==='function')ss.resume()},100)}
